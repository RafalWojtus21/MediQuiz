...
struct Constants {
    static let darkBlueColor = UIColor(red: 61/255, green: 44/255, blue: 141/255, alpha: 1)
    static let backgroundPurpleColor = UIColor(red: 120/255, green: 88/255, blue: 166/255, alpha: 1)
